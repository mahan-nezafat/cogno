...
export const handleBotCommands = async (bot: TelegramBot) => {
    ...
    bot.onText(/\/about/, async (msg) => {
        try {
            ...
            const respose =
                msg.from.language_code === "en"
                    ? `welcome to cogno bot here you can interact with your favorite ai model`
        ...
        try {
            ...
            if (isUser) {
                ...
                return await bot.sendMessage(
                    msg.chat.id,
                    "please first join our channel then try again @cogno_Aibot"
                );
            }
        } catch (error) {
            console.log(error);
